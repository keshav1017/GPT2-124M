...
class GPTConfig:
    ...
    vocab_size: int = 50257 # number of tokens: 50,000 BPE Merges + 256 bytes token + 1 <|endoftext|>
...
class GPT(nn.Module):
    ...
    def from_pretrained(cls, model_type):
        ...
        # n_layer, n_head, and n_embd are deteremined from model_type
        config_args = {
    ...
    def configure_optimizers(self, weight_decay, learning_rate, device_type):
        ...
        # i.e. all weight tensor in matmuls + embeddings decay, all biases and layernorm don't.
